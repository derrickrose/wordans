...
public class Crawl {
	public Crawl(String entryPointUrl) {
		...
		try {
			...
			SwingUtilities.invokeLater(new Runnable() {
				...
				public void run() {
					...
					jop.showMessageDialog(null, "Crawl failed", "Error",
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				JOptionPane jop = new JOptionPane();
				jop.showMessageDialog(null, "Crawl ended", "Information",
	...
	public static Page getPageFromUrl(final String url,
		...
		response = ConnectionHandler.getResponse(url, null, headers,
				methodeType);
	...
	private void offerCrawling(Page page, String productPath) {
		...
		VariantParser variantExtractor = VariantParser.getExtractor(product,
				page);
